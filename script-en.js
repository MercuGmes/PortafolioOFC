...
var projects = [
    {
      title: 'Café Cartago',
      desc: 'Landing page for a local coffee shop in Cartago. Elegant design with product menu, informative sections and smooth navigation.',
    ...
    {
      title: 'FitTrack',
      desc: 'Website for a gym with pricing plans, class schedule and statistics. Modern design with gradients and glassmorphism.',
      tags: ['HTML', 'CSS', 'JavaScript'],
      tagColors: [
    ...
    {
      title: 'DevNotes',
      desc: 'Note-taking web app for developers with code snippets, language categories and professional dashboard design.',
      tags: ['HTML', 'CSS', 'JavaScript'],
      tagColors: [
    ...
    {
      title: 'MercuForge',
      desc: 'Secure password generator with strength meter, history, breach verification via API and security tips.',
      tags: ['HTML', 'CSS', 'JavaScript'],
      tagColors: [
        { bg: 'rgba(167,139,250,0.1)', color: '#a78bfa' },
        { bg: 'rgba(34,211,238,0.1)', color: '#22d3ee' },
    ...
    {
      title: 'BookHaven',
      desc: 'Online bookstore with interactive catalog, genre filters, search, shopping cart, wishlist, detail modal and dynamic sorting.',
      tags: ['HTML', 'CSS', 'JavaScript'],
      tagColors: [
      ...
      desc: 'Text tool with space cleaning, case conversion, special character removal, live preview and animated counters.',
      tags: ['HTML', 'CSS', 'JavaScript'],
      tagColors: [
      ...
      return '<article class="project-card reveal-up" style="--delay: ' + (0.1 + i * 0.08) + 's">' +
        ...
        '<div class="project-body">' +
          ...
          '<div class="project-footer">' +
            ...
            '</a>' +
            '<a href="' + p.github + '" class="project-github" target="_blank" rel="noopener noreferrer" aria-label="Source code">' +
  ...
  function initContactForm() {
    ...
    var fields = {
      name: { el: document.getElementById('name'), err: document.getElementById('nameError'), validate: function (v) { return v.trim().length >= 2 ? '' : 'Please enter your full name.'; } },
      email: { el: document.getElementById('email'), err: document.getElementById('emailError'), validate: function (v) { return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v) ? '' : 'Please enter a valid email.'; } },
      subject: { el: document.getElementById('subject'), err: document.getElementById('subjectError'), validate: function (v) { return v.trim().length >= 3 ? '' : 'Subject must be at least 3 characters.'; } },
      message: { el: document.getElementById('message'), err: document.getElementById('messageError'), validate: function (v) { return v.trim().length >= 10 ? '' : 'Message must be at least 10 characters.'; } }
    };
