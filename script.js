(function () {
      ...
      return '<article class="project-card reveal-up" style="--delay: ' + (0.1 + i * 0.08) + 's">' +
        ...
        '<div class="project-body">' +
          ...
          '<div class="project-footer">' +
            ...
            '</a>' +
            '<a href="' + p.github + '" class="project-github" target="_blank" rel="noopener noreferrer" aria-label="Código fuente">' +
  ...
  function initCursor() {
    ...
    document.querySelectorAll('a, button, .project-card, .about-card, .tool-chip, .social-link, .back-to-top').forEach(function (el) {
